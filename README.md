...
|-------------------------------- |----------------- |------- |--------------:|-------------:|-------------:|--------------:|-----------:|-------------:|
| **0x0100Serialize**                 | **0x0100Serializer** | **100**    |      **19.02 μs** |     **0.127 μs** |     **0.119 μs** |      **19.04 μs** |     **5.0964** |     **31.25 KB** |
| 0x0100Deserialize               | 0x0100Serializer | 100    |      28.09 μs |     0.402 μs |     0.356 μs |      27.97 μs |     9.7961 |     60.16 KB |
| **0x0100Serialize**                 | **0x0100Serializer** | **10000**  |   **1,934.98 μs** |    **16.083 μs** |    **15.044 μs** |   **1,934.42 μs** |   **509.7656** |   **3125.01 KB** |
| 0x0100Deserialize               | 0x0100Serializer | 10000  |   2,769.21 μs |    47.088 μs |    44.046 μs |   2,763.99 μs |   980.4688 |   6015.63 KB |
| **0x0100Serialize**                 | **0x0100Serializer** | **100000** |  **19,246.47 μs** |   **208.207 μs** |   **184.570 μs** |  **19,295.84 μs** |  **5093.7500** |  **31250.14 KB** |
| 0x0100Deserialize               | 0x0100Serializer | 100000 |  29,617.52 μs |   537.471 μs |   639.822 μs |  29,513.80 μs |  9812.5000 |  60156.25 KB |
|                                 |                  |        |               |              |              |               |            |              |
| **0x0200_All_AttachId_Serialize**   | **0x0200Serializer** | **100**    |      **68.22 μs** |     **0.929 μs** |     **0.913 μs** |      **67.86 μs** |    **11.4746** |     **70.33 KB** |
| 0x0200_All_AttachId_Deserialize | 0x0200Serializer | 100    |     379.20 μs |     4.054 μs |     3.792 μs |     378.17 μs |    50.7813 |    311.72 KB |
| **0x0200_All_AttachId_Serialize**   | **0x0200Serializer** | **10000**  |   **7,017.92 μs** |   **122.142 μs** |   **108.276 μs** |   **7,011.70 μs** |  **1140.6250** |   **7033.08 KB** |
| 0x0200_All_AttachId_Deserialize | 0x0200Serializer | 10000  |  39,666.05 μs |   787.275 μs | 1,516.812 μs |  38,948.96 μs |  5076.9231 |  31171.88 KB |
| **0x0200_All_AttachId_Serialize**   | **0x0200Serializer** | **100000** |  **67,774.32 μs** |   **535.331 μs** |   **474.557 μs** |  **67,679.77 μs** | **11375.0000** |  **70331.05 KB** |
| 0x0200_All_AttachId_Deserialize | 0x0200Serializer | 100000 | 389,044.13 μs | 6,220.753 μs | 6,656.136 μs | 387,608.85 μs | 50000.0000 | 311718.75 KB |
