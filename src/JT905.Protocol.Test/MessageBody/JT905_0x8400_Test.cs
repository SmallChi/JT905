...
namespace JT905.Protocol.Test.MessageBody
{
    ...
    /// 系统测试
    /// </summary>
    public class JT905_0x8400_Test
    {
        public JT905Serializer JT905Serializer;
        public JT905_0x8400_Test()
        {
        ...
        public void Test1_Serialize()
        {
            JT905.Protocol.JT905Package package = new JT905Package {
                ...
                {
                    MsgId = Enums.JT905MsgId.电话回拨.ToUInt16Value(),
                    ManualMsgNum = 0,
                    ISU = "108000000316",
                },
                Bodies = new JT905_0x8400() {
                    Flag = 0x00,
            ...
            Assert.Equal("7E8400000E108000000316000000303132333435363738393132000D7E", vs);
        ...
        [Fact]
        public void Test2() {
            var hex = "7E8400000E108000000316000000303132333435363738393132000D7E".ToHexBytes();
        ...
        public void Test3()
        {
            ...
            Assert.Equal(Enums.JT905MsgId.电话回拨.ToUInt16Value(), jT905Package.Header.MsgId);
