...
namespace JT905.Protocol.Test.MessageBody
{
    ...
    /// 系统测试
    /// </summary>
    public class JT905_0x8B10_Test
    {
        public JT905Serializer JT905Serializer;
        public JT905_0x8B10_Test()
        {
        ...
        public void Test1_Serialize()
        {
            JT905.Protocol.JT905Package package = new JT905Package {
                ...
                {
                    MsgId = Enums.JT905MsgId.外围设备指令下行透传.ToUInt16Value(),
                    ManualMsgNum = 0,
                    ISU = "108000000316",
                },
                Bodies = new JT905_0x8B10() {
                    TypeID = Enums.JT905DeviceType.ISU,
                    DataType = 1,
                    DataPacket  = new byte[] { 0,1},

                }
            };
            var _0x8B10Hex = JT905Serializer.Serialize(package).ToHexString();
            Assert.Equal("7E8B100005108000000316000000000100011B7E", _0x8B10Hex);
        ...
        [Fact]
        public void Test2() {
            var hex = "7E8B100005108000000316000000000100011B7E".ToHexBytes();
            
            string _0x8B10Json = JT905Serializer.Analyze(hex, options: JTJsonWriterOptions.Instance);
        ...
        public void Test3()
        {
            ...
            Assert.Equal(Enums.JT905MsgId.外围设备指令下行透传.ToUInt16Value(), jT905Package.Header.MsgId);
