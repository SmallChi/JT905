...
namespace JT905.Protocol.Test.MessageBody
{
    ...
    /// 系统测试
    /// </summary>
    public class JT905_0x0B07_Test
    {
        public JT905Serializer JT905Serializer;
        public JT905_0x0B07_Test()
        {
        ...
        public void Test1_Serialize()
        {
            JT905.Protocol.JT905Package package = new JT905Package {
                ...
                {
                    MsgId = Enums.JT905MsgId.驾驶员电召任务完成确认.ToUInt16Value(),
                    ManualMsgNum = 0,
                    ISU = "108000000316",
                },
                Bodies = new JT905_0x0B07() {
                    BusinessId = 1,

                }
            };
            var _0x0B07Hex = JT905Serializer.Serialize(package).ToHexString();
            Assert.Equal("7E0B0700041080000003160000000000018C7E", _0x0B07Hex);
        ...
        [Fact]
        public void Test2() {
            var hex = "7E0B0700041080000003160000000000018C7E".ToHexBytes();
            
            string _0x0B07Json = JT905Serializer.Analyze(hex, options: JTJsonWriterOptions.Instance);
        ...
        public void Test3()
        {
            ...
            Assert.Equal(Enums.JT905MsgId.驾驶员电召任务完成确认.ToUInt16Value(), jT905Package.Header.MsgId);
