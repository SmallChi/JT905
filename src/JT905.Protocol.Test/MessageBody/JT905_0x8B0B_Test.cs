...
namespace JT905.Protocol.Test.MessageBody
{
    ...
    /// 系统测试
    /// </summary>
    public class JT905_0x8B0B_Test
    {
        public JT905Serializer JT905Serializer;
        public JT905_0x8B0B_Test()
        {
        ...
        public void Test1_Serialize()
        {
            JT905.Protocol.JT905Package package = new JT905Package {
                ...
                {
                    MsgId = Enums.JT905MsgId.中心解除报警.ToUInt16Value(),
                    ManualMsgNum = 0,
                    ISU = "108000000316",
                },
                Bodies = new JT905_0x8B0B() {               }
            };
            var _0x8B0BHex = JT905Serializer.Serialize(package).ToHexString();
            Assert.Equal("7E8B0B00001080000003160000057E", _0x8B0BHex);
        ...
        [Fact]
        public void Test2() {
            var hex = "7E8B0B00001080000003160000057E".ToHexBytes();
            
            string _0x8B0BJson = JT905Serializer.Analyze(hex, options: JTJsonWriterOptions.Instance);
