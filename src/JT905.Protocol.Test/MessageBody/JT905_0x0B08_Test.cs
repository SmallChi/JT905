...
namespace JT905.Protocol.Test.MessageBody
{
    ...
    /// 系统测试
    /// </summary>
    public class JT905_0x0B08_Test
    {
        public JT905Serializer JT905Serializer;
        public JT905_0x0B08_Test()
        {
        ...
        public void Test1_Serialize()
        {
            JT905.Protocol.JT905Package package = new JT905Package {
                ...
                {
                    MsgId = Enums.JT905MsgId.驾驶员取消订单.ToUInt16Value(),
                    ManualMsgNum = 0,
                    ISU = "108000000316",
                },
                Bodies = new JT905_0x0B08() {
                    BusinessId = 1,
                    //CancellationReasons = Enums.JT905CancellationReasons.,

                }
            };
            var _0x0B08Hex = JT905Serializer.Serialize(package).ToHexString();
            Assert.Equal("7E0B08000510800000031600000000000102807E", _0x0B08Hex);
        ...
        [Fact]
        public void Test2() {
            var hex = "7E0B08000510800000031600000000000102807E".ToHexBytes();
            
            string _0x0B08Json = JT905Serializer.Analyze(hex, options: JTJsonWriterOptions.Instance);
        ...
        public void Test3()
        {
            ...
            Assert.Equal(Enums.JT905MsgId.驾驶员取消订单.ToUInt16Value(), jT905Package.Header.MsgId);
