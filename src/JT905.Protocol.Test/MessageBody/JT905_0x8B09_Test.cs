...
namespace JT905.Protocol.Test.MessageBody
{
    ...
    /// 系统测试
    /// </summary>
    public class JT905_0x8B09_Test
    {
        public JT905Serializer JT905Serializer;
        public JT905_0x8B09_Test()
        {
        ...
        public void Test1_Serialize()
        {
            JT905.Protocol.JT905Package package = new JT905Package {
                ...
                {
                    MsgId = Enums.JT905MsgId.中心取消订单.ToUInt16Value(),
                    ManualMsgNum = 0,
                    ISU = "108000000316",
                },
                Bodies = new JT905_0x8B09() {
                    BusinessId = 1,

                }
            };
            var _0x8B09Hex = JT905Serializer.Serialize(package).ToHexString();
            Assert.Equal("7E8B090004108000000316000000000001027E", _0x8B09Hex);
        ...
        [Fact]
        public void Test2() {
            var hex = "7E8B090004108000000316000000000001027E".ToHexBytes();
            
            string _0x8B09Json = JT905Serializer.Analyze(hex, options: JTJsonWriterOptions.Instance);
        ...
        public void Test3()
        {
            ...
            Assert.Equal(Enums.JT905MsgId.中心取消订单.ToUInt16Value(), jT905Package.Header.MsgId);
