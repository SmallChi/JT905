...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0042 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0042>, IJT905Analyze
    {
        ...
        /// 0x0042
        /// </summary>
        public override uint ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0042;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0042.ParamValue = reader.ReadUInt32();
            ...
            writer.WriteNumber($"[{ JT905_0x8103_0x0042.ParamValue.ReadNumber()}]参数值[恢复出厂设置电话号码]", JT905_0x8103_0x0042.ParamValue);
        }
        /// <summary>
        /// 恢复出厂设置电话号码
        /// 0x8103_0x0042
