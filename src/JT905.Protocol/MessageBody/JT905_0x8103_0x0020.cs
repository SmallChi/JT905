...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0020 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0020>, IJT905Analyze
    {
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0020.ParamId = reader.ReadUInt32();
            ...
            writer.WriteNumber($"[{ JT905_0x8103_0x0020.ParamValue.ReadNumber()}]参数值[位置汇报策略，0：定时汇报；1：定距汇报；2：定时和定距汇报]", JT905_0x8103_0x0020.ParamValue);
        }
        /// <summary>
        /// 
        /// </summary>
