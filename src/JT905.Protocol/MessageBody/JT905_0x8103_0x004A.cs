...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x004A : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x004A>, IJT905Analyze
    {
        ...
        /// 0x004A
        /// </summary>
        public override uint ParamId { get; set; } = JT905Constants.JT905_0x8103_0x004A;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x004A.ParamId = reader.ReadUInt32();
            JT905_0x8103_0x004A.ParamLength = reader.ReadByte();
            JT905_0x8103_0x004A.ParamValue = reader.ReadUInt32();
            ...
            writer.WriteNumber($"[{ JT905_0x8103_0x004A.ParamValue.ReadNumber()}]参数值[ISU设备维护密码]", JT905_0x8103_0x004A.ParamValue);
        }
        /// <summary>
        /// ISU设备维护密码
        /// 0x8103_0x004A
