...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0040 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0040>, IJT905Analyze
    {
        ...
        /// 0x0040
        /// </summary>
        public override uint ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0040;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0040.ParamValue = reader.ReadUInt32();
            ...
            writer.WriteNumber($"[{ JT905_0x8103_0x0040.ParamValue.ReadNumber()}]参数值[监控指挥中心电话号码]", JT905_0x8103_0x0040.ParamValue);
        }
        /// <summary>
        /// 监控指挥中心电话号码
        /// 0x8103_0x0040
