...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0040 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0040>, IJT905Analyze
    {
        ...
        /// 0x0040
        /// </summary>
        public override ushort ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0040;
        /// <summary>
        /// 数据长度
        /// </summary>
        public override byte ParamLength { get; set; }
    
        public override string Description => "监控指挥中心电话号码";
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0040.ParamId = reader.ReadUInt16();
            ...
            writer.WriteString($"[{paramValue.ToArray().ToHexString()}]参数值[监控指挥中心电话号码]", JT905_0x8103_0x0040.ParamValue);
