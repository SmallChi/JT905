...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x00A1 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x00A1>, IJT905Analyze
    {
        ...
        /// 0x00A1
        /// </summary>
        public override uint ParamId { get; set; } = JT905Constants.JT905_0x8103_0x00A1;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x00A1.ParamId = reader.ReadUInt32();
            JT905_0x8103_0x00A1.ParamLength = reader.ReadByte();
            JT905_0x8103_0x00A1.ParamValue = reader.ReadUInt32();
