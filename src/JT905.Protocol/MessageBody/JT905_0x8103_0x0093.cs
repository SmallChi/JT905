...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0093 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0093>, IJT905Analyze
    {
        ...
        /// 0x0093
        /// </summary>
        public override uint ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0093;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            writer.WriteNumber($"[{ JT905_0x8103_0x0093.ParamValue.ReadNumber()}]参数值[出租车企业简称]", JT905_0x8103_0x0093.ParamValue);
        }
        /// <summary>
        /// 出租车企业简称
        /// 0x8103_0x0093
