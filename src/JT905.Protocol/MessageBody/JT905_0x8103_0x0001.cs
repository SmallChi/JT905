...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0001 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0001>, IJT905Analyze
    {
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0001.ParamId = reader.ReadUInt32();
            ...
            writer.WriteNumber($"[{ JT905_0x8103_0x0001.ParamValue.ReadNumber()}]参数值[终端心跳发送间隔s]", JT905_0x8103_0x0001.ParamValue);
        }
        /// <summary>
        /// 
        /// </summary>
