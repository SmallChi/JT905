...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0010 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0010>, IJT905Analyze
    {
        ...
        /// 0x0010
        /// </summary>
        public override uint ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0010;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0010.ParamId = reader.ReadUInt32();
            JT905_0x8103_0x0010.ParamLength = reader.ReadByte();
            JT905_0x8103_0x0010.ParamValue = reader.ReadUInt32();
            ...
            writer.WriteNumber($"[{ JT905_0x8103_0x0010.ParamValue.ReadNumber()}]参数值[主服务器APN，无线通信拨号访问点]", JT905_0x8103_0x0010.ParamValue);
        }
        /// <summary>
        /// 主服务器APN，无线通信拨号访问点
        /// 0x8103_0x0010
