...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0090 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0090>, IJT905Analyze
    {
        ...
        /// 0x0090
        /// </summary>
        public override ushort ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0090;
        /// <summary>
        /// 数据长度
        /// </summary>
        public override byte ParamLength { get; set; }
    
        public override string Description => "计价器营运次数限制，0～9999；0表示不做限制";
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0090.ParamId = reader.ReadUInt16();
            ...
            var paramValue = reader.ReadVirtualArray(JT905_0x8103_0x0090.ParamLength);
            JT905_0x8103_0x0090.ParamValue = reader.ReadString(JT905_0x8103_0x0090.ParamLength);
            writer.WriteString($"[{paramValue.ToArray().ToHexString()}]参数值[计价器营运次数限制，0～9999；0表示不做限制]", JT905_0x8103_0x0090.ParamValue);
        ...
        public JT905_0x8103_0x0090 Deserialize(ref JT905MessagePackReader reader, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0090.ParamId = reader.ReadUInt16();
            JT905_0x8103_0x0090.ParamLength = reader.ReadByte();
            JT905_0x8103_0x0090.ParamValue = reader.ReadASCII(JT905_0x8103_0x0090.ParamLength);
