...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0081 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0081>, IJT905Analyze
    {
        ...
        /// 0x0081
        /// </summary>
        public override ushort ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0081;
        /// <summary>
        /// 数据长度
        /// </summary>
        public override byte ParamLength { get; set; } = 4;
    
        public override string Description => "车辆所在的省域ID，1～255";
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0081.ParamId = reader.ReadUInt16();
