...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0028 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0028>, IJT905Analyze
    {
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0028.ParamId = reader.ReadUInt32();
            ...
            writer.WriteNumber($"[{ JT905_0x8103_0x0028.ParamValue.ReadNumber()}]参数值[紧急报警时汇报时间间隔s]", JT905_0x8103_0x0028.ParamValue);
        }
        /// <summary>
        /// 
        /// </summary>
