...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0094 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0094>, IJT905Analyze
    {
        ...
        /// 0x0094
        /// </summary>
        public override ushort ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0094;
        /// <summary>
        /// 数据长度
        /// </summary>
        public override byte ParamLength { get; set; }
    
        public override string Description => "出租车车牌号码(不包括汉字)";
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0094.ParamId = reader.ReadUInt16();
            ...
            var paramValue = reader.ReadVirtualArray(JT905_0x8103_0x0094.ParamLength);
            JT905_0x8103_0x0094.ParamValue = reader.ReadString(JT905_0x8103_0x0094.ParamLength);
            writer.WriteString($"[{paramValue.ToArray().ToHexString()}]参数值[出租车车牌号码(不包括汉字)]", JT905_0x8103_0x0094.ParamValue);
        ...
        public JT905_0x8103_0x0094 Deserialize(ref JT905MessagePackReader reader, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0094.ParamId = reader.ReadUInt16();
            JT905_0x8103_0x0094.ParamLength = reader.ReadByte();
            JT905_0x8103_0x0094.ParamValue = reader.ReadASCII(JT905_0x8103_0x0094.ParamLength);
