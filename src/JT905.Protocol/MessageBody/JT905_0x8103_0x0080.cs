...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0080 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0080>, IJT905Analyze
    {
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0080.ParamId = reader.ReadUInt32();
            ...
            writer.WriteNumber($"[{ JT905_0x8103_0x0080.ParamValue.ReadNumber()}]参数值[车辆里程表读数1/10km]", JT905_0x8103_0x0080.ParamValue);
        }
        /// <summary>
        /// 
        /// </summary>
