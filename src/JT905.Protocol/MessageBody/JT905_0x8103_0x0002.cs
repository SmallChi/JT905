...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0002 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0002>, IJT905Analyze
    {
        ...
        /// 0x0002
        /// </summary>
        public override ushort ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0002;
        /// <summary>
        /// 数据长度
        /// </summary>
        public override byte ParamLength { get; set; } = 4;
    
        public override string Description => "TCP消息应答超时时间，单位为秒(s)";
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0002.ParamId = reader.ReadUInt16();
            JT905_0x8103_0x0002.ParamLength = reader.ReadByte();            
        ...
        /// <returns></returns>
        public JT905_0x8103_0x0002 Deserialize(ref JT905MessagePackReader reader, IJT905Config config)
        {
            JT905_0x8103_0x0002 JT905_0x8103_0x0002 = new JT905_0x8103_0x0002();
            JT905_0x8103_0x0002.ParamId = reader.ReadUInt16();
            JT905_0x8103_0x0002.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public void Serialize(ref JT905MessagePackWriter writer, JT905_0x8103_0x0002 value, IJT905Config config)
        {
