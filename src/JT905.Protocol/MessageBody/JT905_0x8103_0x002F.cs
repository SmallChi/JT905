...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x002F : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x002F>, IJT905Analyze
    {
        ...
        /// 0x002F
        /// </summary>
        public override ushort ParamId { get; set; } = JT905Constants.JT905_0x8103_0x002F;
        /// <summary>
        /// 数据长度
        /// </summary>
        public override byte ParamLength { get; set; } = 4;
    
        public override string Description => "紧急报警时汇报距离间隔，单位为米(m)";
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x002F.ParamId = reader.ReadUInt16();
