...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0043 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0043>, IJT905Analyze
    {
        ...
        /// 0x0043
        /// </summary>
        public override uint ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0043;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0043.ParamId = reader.ReadUInt32();
            JT905_0x8103_0x0043.ParamLength = reader.ReadByte();
            JT905_0x8103_0x0043.ParamValue = reader.ReadUInt32();
            ...
            writer.WriteNumber($"[{ JT905_0x8103_0x0043.ParamValue.ReadNumber()}]参数值[监控指挥中心SMS电话号码]", JT905_0x8103_0x0043.ParamValue);
        }
        /// <summary>
        /// 监控指挥中心SMS电话号码
        /// 0x8103_0x0043
