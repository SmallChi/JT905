...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0011 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0011>, IJT905Analyze
    {
        ...
        /// 0x0011
        /// </summary>
        public override uint ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0011;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0011.ParamValue = reader.ReadUInt32();
            ...
            writer.WriteNumber($"[{ JT905_0x8103_0x0011.ParamValue.ReadNumber()}]参数值[主服务器无线通信拨号用户名]", JT905_0x8103_0x0011.ParamValue);
        }
        /// <summary>
        /// 主服务器无线通信拨号用户名
        /// 0x8103_0x0011
