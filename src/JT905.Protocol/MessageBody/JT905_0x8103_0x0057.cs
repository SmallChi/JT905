...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0057 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0057>, IJT905Analyze
    {
        ...
        /// 0x0057
        /// </summary>
        public override ushort ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0057;
        /// <summary>
        /// 数据长度
        /// </summary>
        public override byte ParamLength { get; set; } = 4;
    
        public override string Description => "连续驾驶时间门限，单位为秒(s)";
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0057.ParamId = reader.ReadUInt16();
            JT905_0x8103_0x0057.ParamLength = reader.ReadByte();            
        ...
        /// <returns></returns>
        public JT905_0x8103_0x0057 Deserialize(ref JT905MessagePackReader reader, IJT905Config config)
        {
            JT905_0x8103_0x0057 JT905_0x8103_0x0057 = new JT905_0x8103_0x0057();
            JT905_0x8103_0x0057.ParamId = reader.ReadUInt16();
            JT905_0x8103_0x0057.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public void Serialize(ref JT905MessagePackWriter writer, JT905_0x8103_0x0057 value, IJT905Config config)
        {
