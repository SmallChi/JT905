...
namespace JT905.Protocol.MessageBody
{
    ...
    public class JT905_0x8103_0x0059 : JT905_0x8103_BodyBase, IJT905MessagePackFormatter<JT905_0x8103_0x0059>, IJT905Analyze
    {
        ...
        /// 0x0059
        /// </summary>
        public override ushort ParamId { get; set; } = JT905Constants.JT905_0x8103_0x0059;
        /// <summary>
        /// 数据长度
        /// </summary>
        public override byte ParamLength { get; set; } = 4;
    
        public override string Description => "最长停车时间，单位为秒(s)";
        ...
        public void Analyze(ref JT905MessagePackReader reader, Utf8JsonWriter writer, IJT905Config config)
        {
            ...
            JT905_0x8103_0x0059.ParamId = reader.ReadUInt16();
            ...
            writer.WriteNumber($"[{JT905_0x8103_0x0059.ParamValue.ReadNumber()}]参数值[最长停车时间，单位为秒(s)]", JT905_0x8103_0x0059.ParamValue);
